...
./test.sh --list -k "runtime and ubuntu and 24.04" docker_install
...
./test.sh --list --internal -k "runtime and ubuntu and 24.04" local_install
...
Full suite (all):       ~12-20 hours (90 tests)
