"""Tutorial language and selector contracts for DX Benchmark.

`tests/dx_agent_dev/test_tutorial.py` 패턴을 dx_benchmark(벤치마크 대시보드)에 맞게 복제.
