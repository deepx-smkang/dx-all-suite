...
This is the Codex counterpart of ``test_compiler_agent_e2e.py`` (Copilot CLI)
and ``test_cursor_compiler_agent_e2e.py`` (Cursor CLI).
"""
...
def scenario(codex_runner, compiler_codex_cli_artifacts_dir) -> ScenarioResult:
    """Execute dx-compiler Scenario via Codex CLI."""
    return codex_runner.run(
        prompt=SCENARIO_PROMPT,
        workdir=COMPILER_ROOT,
        scenario_key="compiler",
        session_log_dir=compiler_codex_cli_artifacts_dir,
