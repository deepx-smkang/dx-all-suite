...
"""
Agent-Driven E2E Test (OpenCode): dx-compiler Scenario — Download + Compile Model
...
This is the OpenCode counterpart of ``test_compiler_agent_e2e.py`` (Copilot CLI)
...
def scenario(opencode_runner, compiler_opencode_artifacts_dir) -> ScenarioResult:
