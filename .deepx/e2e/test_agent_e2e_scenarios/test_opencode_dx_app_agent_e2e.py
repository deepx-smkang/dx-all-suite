...
"""
Agent-Driven E2E Test (OpenCode): dx_app Scenario — Build a Python Detection App
...
This is the OpenCode counterpart of ``test_dx_app_agent_e2e.py`` (Copilot CLI)
...
def scenario(opencode_runner, app_opencode_artifacts_dir) -> ScenarioResult:
    """Execute dx_app Scenario via OpenCode CLI."""
    return opencode_runner.run(
        prompt=SCENARIO_PROMPT,
        workdir=APP_ROOT,
        scenario_key="dx_app",
        session_log_dir=app_opencode_artifacts_dir,
