...
def scenario(codex_runner, stream_codex_cascaded_artifacts_dir) -> ScenarioResult:
    """Execute dx_stream cascaded Scenario via Codex CLI."""
    import shutil as _shutil
    result = codex_runner.run(
        prompt=SCENARIO_PROMPT,
        workdir=STREAM_ROOT,
        scenario_key="dx_stream",
        session_log_dir=stream_codex_cascaded_artifacts_dir,
