...
"""
Agent-Driven E2E Test (Claude Code): dx-runtime Scenario — Route to dx_app AND dx_stream
...
This is the Claude Code counterpart of ``test_runtime_agent_e2e.py`` (Copilot CLI)
