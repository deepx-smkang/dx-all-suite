...
Guide reference:
    dx-compiler/source/docs/05_DX-COMPILER_Agent_Driven_Development.md — Scenario 2
"""
...
# Prompt source: dx-compiler/source/docs/05_DX-COMPILER_Agent_Driven_Development.md — Scenario 2
...
def scenario(copilot_runner, compiler_copilot_cli_artifacts_dir) -> ScenarioResult:
    ...
    return copilot_runner.run(
        ...
        timeout=DEFAULT_TIMEOUT,  # download + compilation + verification — varies by PC spec, model size, and parallel jobs
    )
