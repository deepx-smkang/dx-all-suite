...
"""
Agent-Driven E2E Test (OpenCode): dx_stream Scenario — Detection Pipeline with Tracking
...
This is the OpenCode counterpart of ``test_dx_stream_agent_e2e.py`` (Copilot CLI)
