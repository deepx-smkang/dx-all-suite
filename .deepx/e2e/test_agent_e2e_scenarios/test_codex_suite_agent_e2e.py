...
This is the Codex counterpart of ``test_suite_agent_e2e.py`` (Copilot CLI)
...
def scenario(codex_runner, codex_cli_suite_artifacts_dir) -> ScenarioResult:
    """Execute suite Scenario via Codex CLI."""
...
class TestMandatoryArtifacts:
    ...
    def test_session_json_exists(self, scenario: ScenarioResult):
        ...
        R48: codex produces session.json natively. This test ensures the
...
class TestCodeQuality:
    ...
    def test_compile_pid_r42_compliance(self, scenario: ScenarioResult):
        ...
        codex §4.4 anomaly (iter-18: .dxnn at 13 min, background PID at 71/100
