...
- **YES** → This is an internal SWE task. **STOP and invoke the full SWE Mandatory Skill Sequence:**
  ...
  3. `/dx-swe-writing-plans` — if the plan has >2 steps
...
1. **Create Failing Test Case**
   ...
   - Use the `dx-tdd` skill for writing proper failing tests
...
**Related skills:**
- **dx-tdd** - For creating failing test case (Phase 4, Step 1)
- **dx-verify-completion** - Verify fix worked before claiming success
