...
description: "Build a dx-agent-dev showcase end-to-end: KB-based prompt → recorded real build → complete transcript → artifacts → GIFs → README/docs. RIGID gates prevent recurring mistakes."
---
...
10. **dx_app-based showcases MUST follow the dx_app relocatable script patterns.** A
    ...
    `dx-runtime/dx_app/.deepx/skills/dx-agent-app-build-python/SKILL.md` — run.sh: derive the
